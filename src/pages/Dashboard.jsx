        ...
        <>        
            ...
            <Accordion>
                {content.map(({ question, answer }, index) => (
                    <Card key={index}>
                        <Accordion.Toggle element={Card.Header} eventKey={index}>{question}</Accordion.Toggle>
                        <Accordion.Collapse element={Card.Body} eventKey={index}>{answer}</Accordion.Collapse>
                    </Card>
                ))}
            </Accordion>
        </>
